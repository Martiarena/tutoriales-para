 ...
 * Cart totals
 *
 * This template can be boalridden by copying it to yourtheme/woocommerce/cart/cart-totals.php.
 *
...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
    ...
    <h2 class="title-cart"><?php _e( 'Cart Totals', 'woocommerce' ); ?></h2>
    ...
    <div class="wc-btn-updatecart">
        <input type="submit" class="btn-updatecart" name="update_cart" value="<?php esc_attr_e( 'Update Cart', 'woocommerce' ); ?>" />
    </div>
