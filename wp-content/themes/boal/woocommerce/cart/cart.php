 ...
 * Cart Page
 *
 * This template can be boalridden by copying it to yourtheme/woocommerce/cart/cart.php.
 *
...
<form action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    <div class="row">
        <div class="col-md-7 page-cart">
            ...
            <div class="boal-coupon">
                <div class="actions">

                    <?php if ( wc_coupons_enabled() ) { ?>
                        <div class="coupon input-group">

                            <span for="coupon_code" class="input-group-addon"><?php _e( 'Coupon', 'woocommerce' ); ?>:</span>
