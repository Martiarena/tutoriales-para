 ...
 * Login Form
 *
 * This template can be boalridden by copying it to yourtheme/woocommerce/myaccount/form-login.php.
 *
...
<div class="myaccount-login">
    ...
    <div class="login-wrap">
        ...
        <form method="post" class="login">
            ...
            <div class="login-form-divider"><span><?php esc_attr_e( 'Or', 'boal' ); ?></span></div>
            <input type="button" class="btn-form-login btn btn-default" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
    ...
    <div class="register-wrap">
        <h3 class="title-register"><?php _e( 'Register', 'woocommerce' ); ?></h3>
        ...
        <div class="login-form-divider"><span><?php esc_attr_e( 'Or', 'boal' ); ?></span></div>
        <input type="button" class="btn-form-register btn btn-primary"  value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
    </div>
    <?php endif; ?>
</div>
