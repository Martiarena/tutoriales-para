(function ($) {
    ...
    $(document).ready(function() {
        ...
        controlSlider.each( function() {
            var inputField = $(this).find( '.boal-slider-range-input' ),
                sliderRange = $(this).find( '.boal-slider-range' );

            $(this).find('.boal-slider-range').slider({
                range: "min",
        ...
        $( '.boal-slider-range-input' ).on( 'keyup paste', function() {
            $(this).change();
        ...
        $( '.boal-slider-range-input' ).on( 'change', function() {
