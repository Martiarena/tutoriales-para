 ...
 **/
class boal_about extends WP_Widget{
	...
	public function __construct() {
		...
		$widget_ops = array('classname' => 'about', 'description' => esc_html__('Easy add About.', 'boal'));

		/* Create the widget. */
		parent::__construct('about', esc_html__('+NA: About', 'boal'), $widget_ops, $control_ops);
	}
	/**
	 * font-end widgets
	 */
...
function boal_about(){
	register_widget('boal_about');
}
add_action('widgets_init','boal_about');
?>