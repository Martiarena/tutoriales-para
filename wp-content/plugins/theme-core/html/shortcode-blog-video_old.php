                        ...
                        while ( $the_query->have_posts() ) {
                            $the_query->the_post(); ?>
                                <?php if(has_post_format('video')) :?>
                                        <div class="post-item <?php if ($k == 1) echo esc_attr('active');?>">
                                            <div class="embed-responsive  embed-responsive-16by9 video-responsive post-video single-video embed-responsive embed-responsive-16by9">
                                                ...
                                                <?php if(wp_oembed_get( $sp_video )) {
                                                    $idVideo='video'.$k;
                                                    if ($k == 1) {
                                                        echo boal_oembed_get($sp_video, $auto,'video1');
                                                    } else {
                                                        echo boal_oembed_get($sp_video, 1,$idVideo);
                                                    }
                                                } ?>
                                            </div>
                                            <div class="article-content hidden <?php echo esc_attr($add_class);?>">
                                                ...
                                                <a class="btn-read" href="<?php echo esc_url(get_permalink()); ?>"><?php esc_html_e('Read More','boal');?></a>
                                            </div>
                                        </div>
                                <?php  endif; $k++; ?>
                        <?php }
                        ...
                        <?php
                            ...
                            <?php if(has_post_format('video')) :?>
                                    <div class="post-sidebar clearfix">
                                        <div class="article-image post-image single-image <?php if ($n == 1) echo esc_attr('active');?>"  data-name="video<?php echo esc_attr($n);?>">
