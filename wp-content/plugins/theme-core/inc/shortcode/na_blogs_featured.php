        ...
        vc_map(array(
            ...
            "params" => array(
                ...
                array(
                    ...
                    "param_name" => "date_views",
                    'std' => '-360 days',
                    "value" => array(
                        esc_html__('Today', 'nano' )            => '-1 days',
                        esc_html__('Last Week', 'nano' )        => '-7 days',
                        esc_html__('Two Weeks ago', 'nano' )    => '-14 days',
                        esc_html__('Last Month', 'nano' )       => '-30 days',
                        esc_html__('Last Year', 'nano' )        => '-360 days'
                    )
                ),
                array(
